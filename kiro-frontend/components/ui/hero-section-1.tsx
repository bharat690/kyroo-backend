      ...
      <main className="overflow-hidden">
        ...
        <section>
          <div className="relative pt-24 md:pt-36">
            ...
            >
              <img
                src="https://images.unsplash.com/photo-1462331940025-496dfbfc7564?w=3276&q=80"
                alt="background"
...
const Logo = ({ className }: { className?: string }) => {
  return (
    ...
    >
      ...
      />
      <defs>
        <linearGradient id="logo-gradient" x1="0" y1="0" x2="78" y2="18" gradientUnits="userSpaceOnUse">
